...
print(paste("Mean:", mean_reaction))

# Calculate median
median_reaction <- median(reaction_times)
print(paste("Median:", median_reaction))
...
mode_reaction <- get_mode(reaction_times)
print(paste("Mode:", mode_reaction))

# Calculate variance
variance_reaction <- var(reaction_times)
print(paste("Variance:", variance_reaction))

# Calculate standard deviation
std_deviation_reaction <- sd(reaction_times)
print(paste("Standard Deviation:", std_deviation_reaction))

# Identify outliers using IQR
Q1 <- quantile(reaction_times, 0.25)
Q3 <- quantile(reaction_times, 0.75)
IQR <- Q3 - Q1
...
prob_less_than_250 <- pnorm(250, mean, sd)
print(paste("Probability of a reaction time less than 250 ms:", prob_less_than_250))

# Probability of a reaction time between 250 ms and 350 ms
prob_between_250_and_350 <- pnorm(350, mean, sd) - pnorm(250, mean, sd)
print(paste("Probability of a reaction time between 250 ms and 350 ms:", prob_between_250_and_350))

# Probability of a reaction time more than 400 ms
prob_more_than_400 <- 1 - pnorm(400, mean, sd)
print(paste("Probability of a reaction time more than 400 ms:", prob_more_than_400))
...
prob_less_than_2 <- pt(2, df)
print(paste("Probability of a t-score less than 2:", prob_less_than_2))

...
**Interpretation**: - For every one unit increase in daily exercise, happiness increased by 6.16 points."  
  
**Residuals:** The residuals appear randomly scattered around zero in the residuals plot, indicating that the linear model is appropriate and fits the data well.
...
**Slope:** "For every one unit increase in screen time, sleep quality decreased by 3.18 points."  
  
**Residuals:** The residuals appear randomly scattered around zero in the residuals plot, suggesting that the linear model is appropriate and adequately captures the relationship between screen time and sleep quality.
...
**Slope:** For every one unit increase in coffee consumption, productivity increased by 2.57 points.  
  
**Residuals:** The residuals are randomly distributed around zero, which indicates that the linear model is appropriate for predicting productivity based on coffee consumption.
...
**Slope:** For every one unit increase in social media usage, loneliness increased by 6.61 points.  
  
**Residuals:** The residuals plot shows no obvious pattern, indicating that the linear model is a good fit for predicting loneliness based on social media usage.
...
**Slope:** For every one unit increase in study time, academic performance increased by 2.43 points.  
  
**Residuals:** The residuals are randomly distributed around zero, suggesting that the linear model appropriately captures the relationship between study time and academic performance.
